...
> [!NOTE]
>
> If you are using `Turbopack` and getting an error like `Can't resolve 'next-ts-api'`.
> Please consider updating your tsconfig.
> ```json
> {
>   "paths": {
>     "next-ts-api": ["./node_modules/next-ts-api"]
>   }
> }
> ```
