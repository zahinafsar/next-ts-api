...
<Callout type="warning">
  **Turbopack Not Supported**: Next-TS-API currently does not support Turbopack. Please ensure you are using the default webpack compiler in your Next.js project.
</Callout>
